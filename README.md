...
[![Build, Publish Release](https://github.com/mvallim/amazon-sns-java-messaging-lib/actions/workflows/cd-release.yml/badge.svg)](https://github.com/mvallim/amazon-sns-java-messaging-lib/actions/workflows/cd-release.yml)
...
```groovy
implementation 'com.github.mvallim:amazon-sns-java-messaging-lib-v1:1.4.1'
```

### For AWS SDK v2

```groovy
implementation 'com.github.mvallim:amazon-sns-java-messaging-lib-v2:1.4.1'
```

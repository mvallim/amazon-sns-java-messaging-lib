...
public class AmazonSnsTemplate<E> extends AbstractAmazonSnsTemplate<PublishBatchRequest, PublishBatchResult, E> {
  ...
  public AmazonSnsTemplate(
    ...
    super.amazonSnsConsumer = new AmazonSnsConsumer<>(amazonSNS, topicProperty, objectMapper, super.pendingRequests, super.topicRequests, super.semaphoreProducer, super.semaphoreConsumer);
    super.amazonSnsProducer = new AmazonSnsProducer<>(pendingRequests, topicRequests, super.semaphoreProducer, super.semaphoreConsumer);
